const addFavouriteIcons = document.querySelectorAll('.add-favourite a');
const addCollabIcons= document.querySelectorAll('.add-collab a');
const shareIcons = document.querySelectorAll('.share a');
